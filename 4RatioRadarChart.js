...
function RadarChart2(id, data, options) {
	...
	var allAxis2 = (data[0].map(function(d, i){ return d[axisName] })),	//Names of each axis
		total = allAxis2.length,					//The number of different axes
		radius = Math.min(cfg.w/2, cfg.h/2), 			//Radius of the outermost circle
		Format2 = d3.format('%'),			 	//Percentage formatting
		angleSlice = Math.PI * 2 / total;			//The width in radians of each "slice"
	
	console.log(data[0].map(function(d, i){ return d[axisName] }))
	...
	axisGrid.selectAll(".axisLabel")
	   ...
	   .attr("fill", "#737373")
	   .text(function(d,i) { return Format2(maxValue * d/cfg.levels); });
